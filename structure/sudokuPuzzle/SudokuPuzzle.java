package be.technifutur.decouverte.structure.sudokuPuzzle;
...
public class SudokuPuzzle {
    ...
    public boolean isSafe (int[][] b, int r, int c, int n){
        ...
        for (int r1 = boxRowSt;r1<boxRowSt;r1++){
            for (int d = boxColSt; d < boxColSt; d++){
                if (b[r1][d] == n){
                    return false;
                }
            }
    ...
    int[][] b = new int[][]{
        ...
        if(obj.SolveSudoku(b, size)){
            System.out.println("The solution of rhe grid is : ");
            obj.display(b,size);
        }
        else{
            System.out.println();
